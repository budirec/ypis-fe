...
<template>
  <el-timeline>
    <WelcomeItem :icon="DocumentationIcon">
    ...
    <WelcomeItem :icon="EcosystemIcon">
    ...
    <WelcomeItem :icon="CommunityIcon">
